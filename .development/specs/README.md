...
| 3 | Knowledge base rework | [`implemented/knowledge-base.md`](implemented/knowledge-base.md) + [`../reference/unspoken-content.md`](../reference/unspoken-content.md) | **implemented 2026-09-06**, the same day as the spec: 24 concepts and 5 level pages generated from the data, one page per concept, the map beside the text; §14 records what was decided differently; §9.3–9.4 (the other levels, components) remain; item 2 lands on its short forms |
