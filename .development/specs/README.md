...
| 3 | Knowledge base rework | [`planned/knowledge-base.md`](planned/knowledge-base.md) + [`../reference/unspoken-content.md`](../reference/unspoken-content.md) | **spec written 2026-09-06**: one source, two depths, a fixed page schema per level, pages generated from the data at commit time (decided) — inherits the three census findings; item 2 lands on its short forms |
